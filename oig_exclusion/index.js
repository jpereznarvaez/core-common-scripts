...
//Data
const {exclusion_full_file_nov} = require('./oig_november')
...
const main = async ()=>{
    ...
    if(saveCounter > 0){
        ...
        //
        console.log('\n\nNOTE:\nIf you are not sure about saving the records, please cancel this script [Ctrl + C]. You have 2 minutes to cancel, if you are sure, please wait for the two minutes to end')
